...
public class Coordinater {
    ...
    private void distributeUnits() {
        ...
        //Collections.sort(remainingUnits);
...
//        }
    ...
    private void findPath(Unit unit) throws NoPathException {
        ...
        try {
            ...
            System.out.println("couldn't find a path, setting empty for unit " + unit.id);
            npe.printStackTrace();
...
//         single reservation
    ...
    public boolean iterate() throws NoPathException {
        ...
        if (unitsToFindPath != null) {
        	Collections.sort(unitsToFindPath);
        	//Collections.shuffle(unitsToFindPath);
        	//List<Unit> ListUnit = new ArrayList<Unit>(units.values());
        	//Collections.shuffle(ListUnit);
...
//	            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        c.distributeUnits();
        for (Map.Entry <Integer,List<Unit>> e : c.window.entrySet())
